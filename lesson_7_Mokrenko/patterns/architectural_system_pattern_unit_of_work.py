...
class UnitOfWork:
    ...
    def insert_new(self):
        ...
        for obj in self.new_objects:
            ...
            # print(self.MapperRegistry.get_mapper(obj))
...
class DomainObject:
    '''
    Класс для отметки объектов свойствами, определяющими алгоритм сохранения в БД.
    Каждый метод вытаскивает текущий UoW для потока по умолчанию и регистрирует в нем
    факт изменения данных произвольного объекта.
    '''
